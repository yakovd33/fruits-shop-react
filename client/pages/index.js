			...
			<div className="container">
				<div id="home-main-content">
					...
					<div id="main-products-category-filters">
						<div className={ `main-product-category-filter ${ category == 'all' ? 'active' : ''}` } onClick={ () => setCategory('all') }>הכל</div>
						<div className={ `main-product-category-filter ${ category == 1 ? 'active' : '' }` } onClick={ () => setCategory(1) }>ירקות</div>
						<div className={ `main-product-category-filter ${ category == 2 ? 'active' : '' }` } onClick={ () => setCategory(2) }>פירות</div>
						<div className={ `main-product-category-filter ${ category == 3 ? 'active' : '' }` } onClick={ () => setCategory(3) }>מעדנייה</div>
						<div className={ `main-product-category-filter ${ category == 4 ? 'active' : '' }` } onClick={ () => setCategory(4) }>ירק ופטריות</div>
						<div className={ `main-product-category-filter ${ category == 5 ? 'active' : '' }` } onClick={ () => setCategory(5) }>מזווה</div>
						<div className={ `main-product-category-filter ${ category == 6 ? 'active' : '' }` } onClick={ () => setCategory(6) }>יבשים</div>
